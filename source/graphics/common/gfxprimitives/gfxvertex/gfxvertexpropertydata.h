...
#define POP_DEFINE_VERTEX_PROPERTY(EnumValue, SystemType, DxgiFormat, Semantic, ShortName) \
...
public:
    ...
    POP_DEFINE_VERTEX_PROPERTY(Position2D, vec2, DXGI_FORMAT_R32G32_FLOAT,       "Position",  "P2");
    POP_DEFINE_VERTEX_PROPERTY(Position3D, vec3, DXGI_FORMAT_R32G32B32_FLOAT,    "Position",  "P3");
    POP_DEFINE_VERTEX_PROPERTY(Position4D, vec4, DXGI_FORMAT_R32G32B32A32_FLOAT, "Position",  "P4");
    POP_DEFINE_VERTEX_PROPERTY(Texture2D,  vec2, DXGI_FORMAT_R32G32_FLOAT,       "Texcoord",  "UV2");
    POP_DEFINE_VERTEX_PROPERTY(Normal,     vec3, DXGI_FORMAT_R32G32B32_FLOAT,    "Normal",    "N3");
    POP_DEFINE_VERTEX_PROPERTY(Tagent,     vec3, DXGI_FORMAT_R32G32B32_FLOAT,    "Tangent",   "T3");
    POP_DEFINE_VERTEX_PROPERTY(Bitagent,   vec3, DXGI_FORMAT_R32G32B32_FLOAT,    "Bitangent", "B3");
    POP_DEFINE_VERTEX_PROPERTY(Color4,     vec4, DXGI_FORMAT_R32G32B32A32_FLOAT, "Color",     "C4");
    POP_DEFINE_VERTEX_PROPERTY(Count,      u8,   DXGI_FORMAT_R8_UINT,            "Count",     "Count");
public:
